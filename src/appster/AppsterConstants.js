...
export const AppsterCallback = {
    ...
    APPSTER_PROCESS_TEXT_INPUT_MODAL_ENTER_BUTTON: "processConfirmNaming",
    APPSTER_PROCESS_TEXT_INPUT_MODAL_CANCEL_BUTTON: "processCancelNaming",
    APPSTER_PROCESS_DUPLICATE_OK_BUTTON: "processDuplicateConfirm",
    APPSTER_PROCESS_LENGTH_OK_BUTTON: "processLengthConfirm",
    APPSTER_PROCESS_YES_NO_MODAL_YES_BUTTON: "processConfirmDeleteWork",
    APPSTER_PROCESS_YES_NO_MODAL_NO_BUTTON: "processCancelDeleteWork",
    APPSTER_PROCESS_RENAME_BUTTON: "processChangeName",
    APPSTER_PROCESS_RENAME_CONFIRM_BUTTON: "processConfirmChangeName",
    APPSTER_PROCESS_RENAME_CANCEL_BUTTON: "processCancelChangeName",
    APPSTER_PROCESS_EDIT_FONT_SIDE: "processEditFontSize",
    APPSTER_PROCESS_EDIT_TEXT_COLOR: "processEditTextColor",
    APPSTER_PROCESS_EDIT_BACKGROUND_COLOR: "processEditBackgroundColor",
    APPSTER_PROCESS_EDIT_BORDER_COLOR: "processEditBorderColor",
    APPSTER_PROCESS_EDIT_BORDER_RADIUS: "processEditBorderRadius",
    APPSTER_PROCESS_EDIT_BORDER_THICKNESS: "processEditBorderThickness",
    APPSTER_PROCESS_EDIT_PADDING: "processEditPadding",
    APPSTER_PROCESS_EDIT_MARGIN: "processEditMargin"
};
...
export const AppsterGUIId = {
    ...
    APPSTER_LENGTH_MODAL: 'appster_length_modal',
    APPSTER_LENGTH_MODAL_FRAME: 'appster_length_frame',
    APPSTER_LENGTH_MODAL_HEADER: 'appster_length_modal_header',
    APPSTER_LENGTH_MODAL_SECTION: 'appster_length_modal_section',
    APPSTER_LENGTH_MODAL_OK_BUTTON: 'appster_length_modal_ok_button',
    APPSTER_LENGTH_MODAL_FOOTER: 'appster_length_modal_footer',
    ...
    APPSTER_RENAME_MODAL: 'appster_rename_modal',
    APPSTER_RENAME_MODAL_FRAME: 'appster_rename_modal_frame',
    APPSTER_RENAME_MODAL_HEADER: 'appster_rename_modal_header',
    APPSTER_RENAME_MODAL_SECTION: 'appster_rename_modal_section',
    APPSTER_RENAME_MODAL_TEXTFIELD: 'appster_rename_modal_textfield',
    APPSTER_RENAME_MODAL_ENTER_BUTTON: 'appster_rename_modal_enter_button',
    APPSTER_RENAME_MODAL_CANCEL_BUTTON: 'appster_rename_modal_cancel_button',
    APPSTER_RENAME_MODAL_FOOTER: 'appster_rename_modal_footer'
};
...
export const AppsterText = {
    ...
    //length modal text
    APPSTER_LENGTH_MODAL_PROMPT_TEXT: "appster_length_modal_prompt_text",
    APPSTER_LENGTH_MODAL_OK_BUTTON_TEXT: "appster_length_modal_ok_button_text",
    APPSTER_LENGTH_MODAL_FOOTER_TEXT: "appster_length_modal_footer_text",

    //rename modal text
    APPSTER_RENAME_MODAL_PROMPT_TEXT: "appster_rename_modal_prompt_text",
    APPSTER_RENAME_MODAL_ENTER_BUTTON_TEXT: "appster_rename_modal_enter_button_text",
    APPSTER_RENAME_MODAL_CANCEL_BUTTON_TEXT: "appster_rename_modal_cancel_button_text",
    APPSTER_RENAME_MODAL_FOOTER_TEXT: "appster_rename_modal_footer_text",
