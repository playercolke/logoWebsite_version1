...
export default class AppsterView {
    ...
    loadRoot(appData) {
        ...
        if (!appsterRootDiv) {
            ...
            let appsterLengthModal = this.buildAppsterLengthModal();
            let appsterRenameModal = this.buildAppsterRenameModal();
            ...
            appsterRootDiv.appendChild(appsterLengthModal);
            appsterRootDiv.appendChild(appsterRenameModal);
    ...
    buildAppsterLengthModal() {
        let lengthModal = this.buildElement(    AppsterHTML.DIV,
                                                AppsterGUIId.APPSTER_LENGTH_MODAL,
                                                [AppsterGUIClass.APPSTER_MODAL],
                                                [],
                                                null,
                                                AppsterGUIClass.MODAL_ANIMATION_LEFT);
        let lengthFrame = this.buildElement(AppsterHTML.DIV,
                                            AppsterGUIId.APPSTER_LENGTH_MODAL_FRAME,
                                            [AppsterGUIClass.APPSTER_MODAL_FRAME]);
        let header = this.buildElement( AppsterHTML.HEADER, 
                                        AppsterGUIId.APPSTER_LENGTH_MODAL_HEADER,
                                        [AppsterGUIClass.APPSTER_MODAL_HEADER]);
        let section = this.buildElement(    AppsterHTML.SECTION, 
                                            AppsterGUIId.APPSTER_LENGTH_MODAL_SECTION,
                                            [AppsterGUIClass.APPSTER_MODAL_SECTION]);
        let p = this.buildElement(AppsterHTML.P);
        let strong = this.buildElement( AppsterHTML.STRONG, 
                                        "",
                                        [],
                                        [],
                                        AppsterText.APPSTER_LENGTH_MODAL_PROMPT_TEXT);
        let okButton = this.buildElement(AppsterHTML.BUTTON,
                                        AppsterGUIId.APPSTER_LENGTH_MODAL_OK_BUTTON,
                                        [AppsterGUIClass.APPSTER_MODAL_BUTTON],
                                        [],
                                        AppsterText.APPSTER_LENGTH_MODAL_OK_BUTTON_TEXT);
        let footer = this.buildElement(     AppsterHTML.FOOTER, 
                                        "", 
                                        [AppsterGUIClass.APPSTER_MODAL_FOOTER],
                                        [],
                                        AppsterText.APPSTER_LENGTH_MODAL_FOOTER_TEXT);
        p.appendChild(strong);
        section.appendChild(p);
        lengthFrame.appendChild(header);
        lengthFrame.appendChild(section);
        section.appendChild(okButton);
        lengthFrame.appendChild(footer);
        lengthModal.appendChild(lengthFrame);
        return lengthModal;
    }

    buildAppsterRenameModal() {
        let renameModal = this.buildElement(AppsterHTML.DIV,
                                            AppsterGUIId.APPSTER_RENAME_MODAL,
                                            [AppsterGUIClass.APPSTER_MODAL],
                                            [],
                                            null,
                                            AppsterGUIClass.MODAL_ANIMATION_LEFT);
        let renameFrame = this.buildElement(AppsterHTML.DIV,
                                            AppsterGUIId.APPSTER_RENAME_MODAL_FRAME,
                                            [AppsterGUIClass.APPSTER_MODAL_FRAME]);
        let header = this.buildElement( AppsterHTML.HEADER, 
                                        AppsterGUIId.APPSTER_RENAME_MODAL_HEADER,
                                        [AppsterGUIClass.APPSTER_MODAL_HEADER]);
        let section = this.buildElement(AppsterHTML.SECTION, 
                                        AppsterGUIId.APPSTER_RENAME_MODAL_SECTION,
                                        [AppsterGUIClass.APPSTER_MODAL_SECTION]);
        let p = this.buildElement(AppsterHTML.P);
        let strong = this.buildElement( AppsterHTML.STRONG, 
                                        "",
                                        [],
                                        [],
                                        AppsterText.APPSTER_RENAME_MODAL_PROMPT_TEXT);
        let textFieldAttributes = [];
        textFieldAttributes[AppsterHTML.TYPE] = AppsterHTML.TEXT;
        let textField = this.buildElement(  AppsterHTML.INPUT,
                                            AppsterGUIId.APPSTER_RENAME_MODAL_TEXTFIELD,
                                            [AppsterGUIClass.APPSTER_MODAL_TEXTFIELD],
                                            textFieldAttributes);
        let enterButton = this.buildElement(AppsterHTML.BUTTON,
                                        AppsterGUIId.APPSTER_RENAME_MODAL_ENTER_BUTTON,
                                        [AppsterGUIClass.APPSTER_MODAL_BUTTON],
                                        [],
                                        AppsterText.APPSTER_RENAME_MODAL_ENTER_BUTTON_TEXT);
        let cancelButton = this.buildElement(AppsterHTML.BUTTON,
                                        AppsterGUIId.APPSTER_RENAME_MODAL_CANCEL_BUTTON,
                                        [AppsterGUIClass.APPSTER_MODAL_BUTTON],
                                        [],
                                        AppsterText.APPSTER_RENAME_MODAL_CANCEL_BUTTON_TEXT);
        let footer = this.buildElement( AppsterHTML.FOOTER, 
                                        "", 
                                        [AppsterGUIClass.APPSTER_MODAL_FOOTER],
                                        [],
                                        AppsterText.APPSTER_RENAME_MODAL_FOOTER_TEXT);
        p.appendChild(strong);
        section.appendChild(p);
        renameFrame.appendChild(header);
        renameFrame.appendChild(section);
        section.appendChild(textField);
        section.appendChild(enterButton);
        section.appendChild(cancelButton);
        renameFrame.appendChild(footer);
        renameModal.appendChild(renameFrame);
        return renameModal;
    }
