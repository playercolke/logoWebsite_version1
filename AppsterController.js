...
export default class AppsterController {
    ...
    registerAppsterEventHandlers() {
        ...
        // naming box
        this.registerEventHandler(AppsterGUIId.APPSTER_TEXT_INPUT_MODAL_ENTER_BUTTON, AppsterHTML.CLICK, this[AppsterCallback.APPSTER_TEXT_INPUT_MODAL_ENTER_BUTTON]);
    }
